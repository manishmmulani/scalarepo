...
object GoogleVsApple {
  ...
  lazy val googleTweets: TweetSet = allTweets.filter(tw => google.exists(str => tw.text.contains(str)))
  lazy val appleTweets: TweetSet = allTweets.filter(tw => apple.exists(str => tw.text.contains(str)))
